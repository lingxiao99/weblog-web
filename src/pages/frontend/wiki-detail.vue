        ...
        <div class="max-w-3xl mx-auto xl:max-w-none xl:ml-0 xl:mr-[15.5rem] xl:pr-16">
          ...
          <article>
            ...
            <div class="flex items-center text-gray-500 text-sm">
              <svg t="1705985882454" class="icon inline-block w-4 h-4 mr-1 mt-5 mb-5" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="7701" width="200" height="200">
                <path
            ...
            <nav class="flex flex-row mt-7" v-if="preNext">
              ...
              <div class="basis-1/2">
                <!-- text-right 指定文字居右显示 -->
                <a v-if="preNext.nextArticle" @click="goWikiArticleDetailPage(preNext.nextArticle.articleId)"
