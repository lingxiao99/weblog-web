<template>
  ...
  <!-- 主内容区域 -->
  <main class="container max-w-screen-xl mx-auto p-4 px-6 admin-container">
    <!-- grid 表格布局，分为 4 列 -->
      ...
      <div class="col-span-4 md:col-span-3 mb-3">
        ...
        <div class="p-5 mb-4 border border-gray-200 rounded-lg bg-white dark:bg-gray-800 dark:border-gray-700">
          ...
          <h2 class="flex items-center mb-5 font-bold text-gray-900 uppercase dark:text-white">
            ...
            <svg t="1698998570037" class="inline icon w-5 h-5 mr-2" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="21572" width="200" height="200">
              <path
              ...
              <path d="M805.925926 398.222222h-587.851852v-125.155555c0-24.651852 20.859259-45.511111 45.511111-45.511111h496.82963c24.651852 0 45.511111 20.859259 45.511111 45.511111V398.222222z"
                fill="#D9E3FF" p-id="21574"></path>
              <path d="M843.851852 417.185185h-663.703704v-98.607407c0-28.444444 22.755556-53.096296 53.096296-53.096297h559.407408c28.444444 0 53.096296 22.755556 53.096296 53.096297V417.185185z"
          ...
          <div class="text-sm flex flex-wrap gap-3 font-medium text-gray-600 rounded-lg dark:border-gray-600 dark:text-white">
            <a @click="goCategoryArticleListPage(category.id, category.name)" v-for="(category, index) in categories" :key="index"
              :class="[route.query.name == category.name ? 'bg-sky-100 hover:bg-sky-200' : 'hover:bg-gray-100']" class="inline-flex cursor-pointer items-center px-4 py-2 text-sm font-medium text-center border rounded-lg 
        ...
        <div class="p-5 mb-4 border border-gray-200 rounded-lg bg-white dark:bg-gray-800 dark:border-gray-700">
          ...
          <div v-else class="flex items-center justify-center flex-col">
            <svg height="300" node-id="1" sillyvg="true" template-height="600" template-width="600" version="1.1" viewBox="0 0 600 600" width="600" xmlns="http://www.w3.org/2000/svg"
              xmlns:xlink="http://www.w3.org/1999/xlink">
              <defs node-id="58">
                <linearGradient gradientUnits="objectBoundingBox" id="linearGradient-1" node-id="5" spreadMethod="pad" x1="1.4458808" x2="0.29515958" y1="0.6691032" y2="0.6732615">
                  <stop offset="0" stop-color="#e0e5ef" stop-opacity="0" />
                  <stop offset="1" stop-color="#e0e5ef" />
                </linearGradient>
                <linearGradient gradientUnits="objectBoundingBox" id="linearGradient-2" node-id="8" spreadMethod="pad" x1="1.4458808" x2="0.29515958" y1="0.670017" y2="0.67419773">
                  <stop offset="0" stop-color="#e0e5ef" stop-opacity="0" />
                  <stop offset="1" stop-color="#e0e5ef" />
                </linearGradient>
                <linearGradient gradientUnits="objectBoundingBox" id="linearGradient-3" node-id="11" spreadMethod="pad" x1="0.9340618" x2="0.40599936" y1="0.988" y2="1">
                  <stop offset="0" stop-color="#e0e5ef" stop-opacity="0" />
                  <stop offset="1" stop-color="#e0e5ef" />
                </linearGradient>
                <linearGradient gradientUnits="objectBoundingBox" id="linearGradient-4" node-id="14" spreadMethod="pad" x1="0.9251822" x2="0.40792233" y1="0.988" y2="1">
                  <stop offset="0" stop-color="#e0e5ef" stop-opacity="0" />
                  <stop offset="1" stop-color="#e0e5ef" />
                </linearGradient>
                <linearGradient gradientUnits="objectBoundingBox" id="linearGradient-5" node-id="17" spreadMethod="pad" x1="0.5" x2="0.5" y1="1" y2="-0.268682">
              ...
              <g node-id="89">
                <path
                  ...
                  fill="#f3f3fa" fill-opacity="0.6015942" fill-rule="evenodd" group-id="1" id="背景" node-id="21" stroke="none" target-height="442" target-width="543" target-x="29" target-y="77" />
              </g>
              <path
                ...
                fill="url(#linearGradient-1)" fill-rule="nonzero" id="路径" node-id="22" stroke="none" target-height="53" target-width="90.034676" target-x="121.93691" target-y="154.4683" />
              <path
                ...
                fill="url(#linearGradient-2)" fill-rule="nonzero" id="路径" node-id="23" stroke="none" target-height="38" target-width="64.379456" target-x="381" target-y="135" />
              <path
                ...
                fill="#e7eaf0" fill-rule="evenodd" id="形状结合" node-id="24" stroke="none" target-height="115" target-width="435" target-x="73" target-y="415" />
              <path
                ...
                fill="#d1d6e2" fill-rule="nonzero" id="椭圆形" node-id="25" stroke="none" target-height="18" target-width="69" target-x="215" target-y="457.09875" />
              <path
                ...
                fill="url(#linearGradient-3)" fill-rule="nonzero" group-id="2" id="路径" node-id="27" stroke="none" target-height="62" target-width="42" target-x="422" target-y="370" />
              <path
                ...
                fill="url(#linearGradient-3)" fill-rule="nonzero" group-id="2" id="路径" node-id="28" stroke="none" target-height="62" target-width="42" target-x="462" target-y="390" />
              <path
                ...
                fill="url(#linearGradient-4)" fill-rule="nonzero" group-id="2" id="路径" node-id="29" stroke="none" target-height="88" target-width="59" target-x="92" target-y="370" />
              <path
                ...
                fill="#d9dfe8" fill-rule="evenodd" group-id="3" id="矩形" node-id="31" stroke="none" target-height="146" target-width="160" target-x="164" target-y="263" />
              <path d="M 181.00 295.00 L 311.00 295.00 L 311.00 439.00 L 181.00 439.00 Z" fill="#a2abb9" fill-rule="evenodd" group-id="3" id="矩形" node-id="32" stroke="none" target-height="144"
                target-width="130" target-x="181" target-y="295" />
              <path d="M 178.00 309.00 L 314.00 309.00 L 314.00 436.00 L 178.00 436.00 Z" fill="#ffffff" fill-rule="evenodd" group-id="3" id="矩形" node-id="33" stroke="none" target-height="127"
                target-width="136" target-x="178" target-y="309" />
              <path d="M 177.00 318.00 L 318.00 318.00 L 318.00 435.00 L 177.00 435.00 Z" fill="#c8cede" fill-rule="evenodd" group-id="3" id="矩形" node-id="34" stroke="none" target-height="117"
                target-width="141" target-x="177" target-y="318" />
              <path d="M 151.00 331.00 L 341.00 331.00 L 323.73 439.00 L 168.27 439.00 Z" fill="url(#linearGradient-5)" fill-rule="nonzero" group-id="3" id="矩形" node-id="35" stroke="none"
                target-height="108" target-width="190" target-x="151" target-y="331" />
              <path
                ...
                fill="#d9dfe8" fill-rule="evenodd" group-id="3" id="矩形" node-id="36" stroke="none" target-height="7" target-width="7" target-x="261" target-y="378" />
              <path
                ...
                fill="#d9dfe8" fill-rule="evenodd" group-id="3" id="矩形" node-id="37" stroke="none" target-height="7" target-width="31" target-x="275" target-y="378" />
              <path
                ...
                fill="#d9dfe8" fill-rule="evenodd" group-id="3" id="矩形备份-2" node-id="38" stroke="none" target-height="7" target-width="45" target-x="260" target-y="393" />
              <path
                ...
                fill="#d9dfe8" fill-rule="evenodd" group-id="3" id="椭圆形" node-id="39" stroke="none" target-height="30" target-width="30" target-x="221" target-y="241" />
              <path d="M 236.00 261.00 L 230.12 264.09 L 231.24 257.55 L 226.49 252.91 L 233.06 251.95 L 236.00 246.00 L 238.94 251.95 L 245.51 252.91 L 240.76 257.55 L 241.88 264.09 Z" fill="#ffffff"
                fill-rule="evenodd" group-id="3" id="星形" node-id="40" stroke="none" target-height="18.09018" target-width="19.021118" target-x="226.48944" target-y="246" />
              <path
                ...
                fill="#c0c9db" fill-rule="evenodd" group-id="3" id="椭圆形" node-id="41" stroke="none" target-height="64" target-width="64" target-x="312" target-y="223" />
              <path
                ...
                fill="#ffffff" fill-rule="nonzero" group-id="3" id="形状" node-id="42" stroke="none" target-height="34" target-width="20" target-x="334" target-y="238" />
              <path
                ...
                fill="#a2abb9" fill-rule="nonzero" group-id="4" id="路径" node-id="44" stroke="none" target-height="36.924408" target-width="22.992584" target-x="368.0036" target-y="310.04767" />
              <path
                ...
                fill="#a2abb9" fill-rule="nonzero" group-id="4" id="路径" node-id="45" stroke="none" target-height="40.984985" target-width="29.95758" target-x="394" target-y="319.01486" />
              <path
                ...
                fill="#acb4c2" fill-rule="nonzero" group-id="4" id="路径" node-id="46" stroke="none" target-height="29.987915" target-width="26.985718" target-x="358.01428" target-y="351.9996" />
              <path
                ...
                fill="#909aa9" fill-rule="nonzero" group-id="4" id="路径" node-id="47" stroke="none" target-height="32.93387" target-width="37.947357" target-x="402.0098" target-y="339.0409" />
              <path
                ...
                fill="#9da5b5" fill-rule="nonzero" group-id="4,5" id="路径" node-id="48" stroke="none" target-height="19.704224" target-width="24.921417" target-x="408.91635" target-y="360.7389" />
              <path
                ...
                fill="#a2abb9" fill-rule="nonzero" group-id="4,6" id="路径" node-id="49" stroke="none" target-height="87.49216" target-width="11.486877" target-x="386.2541" target-y="337.11166" />
              <path
                ...
                fill="#a2abb9" fill-rule="nonzero" group-id="4,7" id="路径" node-id="50" stroke="none" target-height="89.92609" target-width="20.01233" target-x="388.90866" target-y="334.14902" />
              <path
                ...
                fill="#a2abb9" fill-rule="nonzero" group-id="4" id="路径" node-id="51" stroke="none" target-height="71.930725" target-width="19.96933" target-x="397.0023" target-y="353.03717" />
              <path
                ...
                fill="#a2abb9" fill-rule="nonzero" group-id="4" id="路径" node-id="52" stroke="none" target-height="53.99884" target-width="15.979828" target-x="400.02" target-y="369.0002" />
              <path
                ...
                fill="#a2abb9" fill-rule="nonzero" group-id="4,8" id="路径" node-id="53" stroke="none" target-height="56.921204" target-width="17.021759" target-x="375.567" target-y="366.60376" />
              <path
                ...
                fill="#acb4c2" fill-rule="nonzero" group-id="4" id="路径" node-id="54" stroke="none" target-height="37.964294" target-width="13.975433" target-x="394.0235" target-y="382.03568" />
              <path
                ...
                fill="#d1d6e2" fill-rule="nonzero" group-id="4" id="矩形" node-id="55" stroke="none" target-height="5" target-width="33" target-x="380" target-y="467" />
              <path
                ...
                fill="#c0c7d2" fill-rule="evenodd" group-id="4" id="矩形" node-id="56" stroke="none" target-height="46" target-width="33.334473" target-x="380.8566" target-y="423" />
            </svg>
            <p class="mt-2 mb-16 text-gray-400">此分类下还未发布文章哟~~~</p>
          </div>
        </div>
        <!-- 分页 -->
        <nav v-if="pages > 0" aria-label="Page navigation example" class="mt-10 flex justify-center">
          <ul class="flex items-center -space-x-px h-10 text-base">
            <!-- 上一页 -->
            <li>
              <a @click="getCategoryArticles(current - 1)" :class="[current > 1 ? '' : 'cursor-not-allowed']"
            ...
            <!-- 下一页 -->
            <li>
              <a @click="getCategoryArticles(current + 1)" :class="[current < pages ? '' : 'cursor-not-allowed']"
