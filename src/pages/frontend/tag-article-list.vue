  ...
  <main class="container max-w-screen-xl mx-auto p-4 px-6 admin-container ">
    ...
    <div class="grid grid-cols-4 gap-7">
      ...
      <div class="col-span-4 md:col-span-3 mb-3">
        ...
        <!-- 标签 -->
        <div v-if="tags && tags.length > 0" class="w-full p-5 pb-7 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">

          <!-- 标签标题 -->
          <h2 class="flex items-center mb-5 font-bold text-gray-900 uppercase dark:text-white">
            <!-- 标签图标 -->
            <svg t="1698980289658" class="icon w-5 h-5 mr-2" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="13858" width="200" height="200">
          ...
          <div class="flex flex-wrap gap-3">
            <!-- <a v-for="(tag, index) in tags" :key="index" @click="goTagArticleListPage(tag.id, tag.name)" :class="[route.query.name == tag.name ? 'bg-sky-100 hover:bg-sky-200' : 'hover:bg-gray-100']"
              class="cursor-pointer inline-flex items-center px-3.5 py-1.5 text-xs font-bold text-center border rounded-[12px]
            ...
            dark:border-gray-700 dark:hover:text-white hover:scale-110 cursor-pointer"> -->
