    ...
    <div class="grid grid-cols-4 gap-7">
      ...
      <div class="col-span-4 md:col-span-1">
        ...
        <div class="flex items-center w-full px-5 py-7 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
          <svg t="1699865769161" class="icon w-10 h-10" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="6627" width="200" height="200">
            <path d="M0 0h1024v1024H0V0z" fill="#202425" opacity=".01" p-id="6628"></path>
            <path d="M682.666667 341.333333a136.533333 136.533333 0 0 1 273.066666 0v546.133334a68.266667 68.266667 0 0 1-68.266666 68.266666h-204.8V341.333333z" fill="#FFAA44" p-id="6629"></path>
            <path
      ...
      <div class="col-span-4 md:col-span-1">
        <!-- 卡片 -->
        <div class="flex items-center w-full px-5 py-7 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
          <svg t="1699866300645" class="icon w-10 h-10" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="15660" width="200" height="200">
      ...
      <div class="col-span-4 md:col-span-1">
        <!-- 卡片 -->
        <div class="flex items-center w-full px-5 py-7 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
          <svg t="1699866473165" class="icon w-10 h-10" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="27760" width="200" height="200">
            <path
            ...
            <path d="M273.654138 828.360914L778.193649 634.858545H245.806178v174.868808a20.476441 20.476441 0 0 0 27.84796 18.633561z" fill="#FFFFFF" p-id="27765"></path>
            <path
      ...
      <div class="col-span-4 md:col-span-1">
        <!-- 卡片 -->
        <div class="flex items-center w-full  px-5 py-7 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
          <svg t="1699866701804" class="icon w-10 h-10" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="37369" width="200" height="200">
            <path d="M365.3 921.9c-39.7 0-72.2-32.5-72.2-72.2v-591c0-39.7 32.5-72.2 72.2-72.2h459.5c39.7 0 72.2 32.5 72.2 72.2v590.5c0 39.7-32.5 72.2-72.2 72.2H365.3v0.5z" fill="#FFBA40" p-id="37370">
            </path>
            <path
            ...
            <path d="M365.3 839.1c-39.7 0-72.2-32.5-72.2-72.2V176c0-39.7 32.5-72.2 72.2-72.2h459.5c39.7 0 72.2 32.5 72.2 72.2v590.5c0 39.7-32.5 72.2-72.2 72.2H365.3v0.4z" fill="#FFBA40" p-id="37372">
            </path>
            <path
            ...
            <path d="M225.7 921.9C155.9 921.9 99 865 99 795.2s56.9-126.7 126.7-126.7 126.7 56.9 126.7 126.7-56.9 126.7-126.7 126.7z" fill="#27C18F" p-id="37376"></path>
            <path
            ...
            <path d="M570.9 921.9c-69.8 0-126.7-56.9-126.7-126.7s56.9-126.7 126.7-126.7 126.7 56.9 126.7 126.7-56.9 126.7-126.7 126.7z" fill="#27C18F" p-id="37378"></path>
            <path
      ...
      <div class="col-span- md:col-span-2">
        ...
        <div class="w-full h-full px-5 py-7 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
          <h2 class="flex items-center mb-2 font-bold text-gray-600 uppercase dark:text-white">
            <!-- 日历图标 -->
            <svg t="1699867752559" class="icon w-5 h-5 mr-2" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="43935" width="200" height="200">
              <path d="M897.9 369.2H205c-33.8 0-61.4-27.6-61.4-61.4s27.6-61.4 61.4-61.4h692.9c33.8 0 61.4 27.6 61.4 61.4s-27.6 61.4-61.4 61.4z" fill="#FFB89A" p-id="43936"></path>
              <path
      ...
      <div class="col-span-4 md:col-span-2">
        ...
        <div class="w-full h-full px-5 py-7 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
          <h2 class="flex items-center mb-2 font-bold text-gray-600 uppercase dark:text-white">
            <!-- 折线图标 -->
            <svg t="1699872552774" class="icon w-5 h-5 mr-2" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="58226" width="200" height="200">
              <path
          ...
          <div>
            <ArticleLineChat :value="articlePVInfo"></ArticleLineChat>
          </div>
        </div>
      </div>
    </div>
...
import ArticlePublish from '@/components/ArticlePublishCalendar.vue'
import ArticleLineChat from '@/components/ArticleLineChat.vue'
