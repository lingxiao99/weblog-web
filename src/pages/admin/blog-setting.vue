    ...
    <el-card shadow="never">
      ...
      <el-form :model="form" ref="formRef" label-width="160px" :rules="rules">
        ...
        <el-form-item label="博客 LOGO" prop="logo">
          <el-upload class="avatar-uploader" action="#" :on-change="handleLogoChange" :auto-upload="false" :show-file-list="false">
        ...
        <el-form-item label="作者头像" prop="avatar">
          <el-upload class="avatar-uploader" action="#" :auto-upload="false" :on-change="handleAvatarChange" :show-file-list="false">
        ...
        <el-form-item label="开启 GihHub 访问">
          <el-switch v-model="isGithubChecked" inline-prompt :active-icon="Check" :inactive-icon="Close" @change="githubSwitchChange" />
        </el-form-item>
        ...
        <el-form-item label="开启 Gitee 访问">
          <el-switch v-model="isGiteeChecked" inline-prompt :active-icon="Check" :inactive-icon="Close" @change="giteeSwitchChange" />
        </el-form-item>
        ...
        <el-form-item label="开启知乎访问">
          <el-switch v-model="isZhihuChecked" inline-prompt :active-icon="Check" :inactive-icon="Close" @change="zhihuSwitchChange" />
        </el-form-item>
        ...
        <el-form-item label="开启 CSDN 访问">
          <el-switch v-model="isCSDNChecked" inline-prompt :active-icon="Check" :inactive-icon="Close" @change="csdnSwitchChange" />
        </el-form-item>
        ...
        <el-form-item label="敏感词过滤">
          <el-switch v-model="form.isCommentSensiWordOpen" inline-prompt :active-icon="Check" :inactive-icon="Close" @change="sensiWordSwitchChange" />
        ...
        <el-form-item label="开启审核">
          <el-switch v-model="form.isCommentExamineOpen" inline-prompt :active-icon="Check" :inactive-icon="Close" @change="examineSwitchChange" />
          <div class="flex items-center ml-3">
            <el-icon class="mr-2" color="#909399">
              <InfoFilled />
            </el-icon>
