<template>
  ...
  <div v-if="titles && titles.length > 0" class="sticky  text-sm/[30px] w-full  mb-3  transition-all " :class="[currScrollY > 0 ? 'top-0' : 'top-[5.5rem]']">
    <!-- 目录标题 -->
    <h2 class="flex items-center mb-2 font-bold text-gray-900 uppercase dark:text-gray-400">
      <!-- 目录图标 -->
      <svg t="1699441758495" class="icon w-3.5 h-3.5 mr-2" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4043" width="200" height="200">
        <path
        ...
        <path d="M281.6 691.2a51.2 51.2 0 1 1 0 102.4 51.2 51.2 0 0 1 0-102.4z m0-230.4a51.2 51.2 0 1 1 0 102.4 51.2 51.2 0 0 1 0-102.4z m0-230.4a51.2 51.2 0 1 1 0 102.4 51.2 51.2 0 0 1 0-102.4z"
          fill="#FFBA00" p-id="4045"></path>
      </svg>
      文章目录
    </h2>
    <div class="border-l-2 border-gray-200 toc-wrapper " :class="[isDark ? 'dark' : '']">
      <ul class="toc">
        <!-- 二级标题 -->
