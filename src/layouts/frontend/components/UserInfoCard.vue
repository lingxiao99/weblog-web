    ...
    <div class="flex flex-col items-center">
      ...
      <div class="flex justify-center  gap-2 ">
        ...
        <svg @click="jump(blogSettingsStore.blogSettings.githubHomepage)" v-if="blogSettingsStore.blogSettings.githubHomepage" t="1698029949662" data-tooltip-target="github-tooltip-bottom"
          data-tooltip-placement="bottom" class=" icon mt-5 w-7 h-7  hover:scale-110 cursor-pointer" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1447" width="200"
          height="200" outline-none>
        ...
        <div id="github-tooltip-bottom" role="tooltip"
          class=" text-xs rounded absolute z-10 invisible inline-block px-3 py-2  font-medium text-white bg-gray-900  shadow-sm opacity-0 tooltip dark:bg-gray-700">
          我的 GitHub
          <div class="tooltip-arrow" data-popper-arrow></div>
        </div>
        <!-- Gitee -->
        <svg t="1698030969736" @click="jump(blogSettingsStore.blogSettings.giteeHomepage)" v-if="blogSettingsStore.blogSettings.giteeHomepage" data-tooltip-target="gitee-tooltip-bottom"
          data-tooltip-placement="bottom" class="icon w-7 h-7 mt-5  hover:scale-110 cursor-pointer" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2438" width="200"
          height="200" outline-none>
          <path
        ...
        <!-- 知乎 -->
        <svg t="1698031258903" @click="jump(blogSettingsStore.blogSettings.zhihuHomepage)" v-if="blogSettingsStore.blogSettings.zhihuHomepage" data-tooltip-target="zhihu-tooltip-bottom"
          data-tooltip-placement="bottom" class="icon w-7 h-7 mt-5  hover:scale-110 cursor-pointer" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3419" width="200"
          height="200" outline-none>
        ...
        <svg @click="jump(blogSettingsStore.blogSettings.csdnHomepage)" v-if="blogSettingsStore.blogSettings.csdnHomepage" t="1698031311586" data-tooltip-target="csdn-tooltip-bottom"
          data-tooltip-placement="bottom" class="icon mt-5 w-7 h-7  hover:scale-110 cursor-pointer" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4386" width="200"
          height="200" outline-none>
          <path
