  ...
  <div class="w-full py-5 px-2 mb-2 max-w-sm bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700 ">
    <div class="flex flex-col items-center">
      ...
      <div class="relative mb-4">
        <img class="w-32 h-32 rounded-full shadow-lg" :src="blogSettingsStore.blogSettings.avatar" />
        <span class="bottom-1 left-24 absolute w-5 h-5 bg-green-400 border-2 border-white dark:border-gray-800 rounded-full"></span>
      </div>
      ...
      <div class="flex justify-center gap-6 -mt-2">
        <!-- GitHub -->
        <svg @click="jump(blogSettingsStore.blogSettings.githubHomepage)" v-if="blogSettingsStore.blogSettings.githubHomepage" t="1698029949662" data-tooltip-target="github-tooltip-bottom"
          data-tooltip-placement="bottom" class="hover:scale-110 icon mt-5 w-7 h-7" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1447" width="200" height="200">
        ...
        <!-- Gitee -->
        <svg @click="jump(blogSettingsStore.blogSettings.giteeHomepage)" v-if="blogSettingsStore.blogSettings.giteeHomepage" t="1698030969736" data-tooltip-target="gitee-tooltip-bottom"
          data-tooltip-placement="bottom" class="hover:scale-110 icon mt-5 w-7 h-7" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2438" width="200" height="200">
          <path
        ...
        <!-- 知乎 -->
        <svg @click="jump(blogSettingsStore.blogSettings.zhihuHomepage)" v-if="blogSettingsStore.blogSettings.zhihuHomepage" t="1698031258903" data-tooltip-target="zhihu-tooltip-bottom"
          data-tooltip-placement="bottom" class="hover:scale-110 icon mt-5 w-7 h-7" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3419" width="200" height="200">
          ...
          <path d="M594.752 368.64h117.952v277.888h-41.92l-53.376 40.256-11.648-40.32h-11.008V368.64z" fill="#0F84FD" p-id="3422"></path>
        </svg>
        ...
        <!-- CSDN -->
        <svg @click="jump(blogSettingsStore.blogSettings.csdnHomepage)" v-if="blogSettingsStore.blogSettings.csdnHomepage" t="1698031311586" data-tooltip-target="csdn-tooltip-bottom"
          data-tooltip-placement="bottom" class="hover:scale-110 icon mt-5 w-7 h-7" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4386" width="200" height="200">
          <path
