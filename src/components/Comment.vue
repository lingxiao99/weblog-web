        ...
        <div class="flex gap-3 mt-5">
          ...
          <div class="flex flex-col gap-2 grow">
            ...
            <div class="flex items-center text-xs text-gray-400">
              ...
              <div class="text-gray-400 cursor-pointer ml-4 hover:text-sky-600" @click="showReplyForm(index, comment.nickname, comment.id, comment.id)">
                回复
              </div>
            </div>
          </div>
        ...
        <div class="ml-12" v-if="comment.childComments && comment.childComments.length > 0">
          <div v-for="(childComment, index2) in comment.childComments" :key="index2">
            ...
            <div class="ml-9 mt-1 flex items-center text-xs text-gray-400">
              ...
              <div class="text-gray-400 cursor-pointer ml-4 hover:text-sky-600" @click="showReplyForm(index, childComment.nickname, childComment.id, comment.id)">
                回复
              </div>
            </div>
          </div>
...
text-xs font-medium text-white bg-gray-900 rounded-md shadow-sm opacity-0 tooltip dark:bg-gray-700">
                ...
                <div class="flex basis-1/3">
                  ...
                  <input v-model="commentStore.userInfo.mail" data-tooltip-target="mail-tooltip-click2" data-tooltip-trigger="click" type="text" id="website-admin" class="rounded-none rounded-e-lg  border text-gray-900 focus:ring-sky-500 
focus:border-sky-500 block flex-1 min-w-0 w-full text-xs border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 
dark:placeholder-gray-400 dark:text-white dark:focus:ring-sky-500 dark:focus:border-sky-500" placeholder="必填">
                  <!-- 邮箱 Tooltip -->
...
text-xs font-medium text-white bg-gray-900 rounded-md shadow-sm opacity-0 tooltip dark:bg-gray-700">
                ...
                <div class="flex basis-1/3">
                  ...
                  <input v-model="commentStore.userInfo.website" data-tooltip-target="website-tooltip-click2" data-tooltip-trigger="click" type="text" id="website-admin" class="rounded-none rounded-e-lg  border text-gray-900 
focus:ring-sky-500 focus:border-sky-500 block flex-1 min-w-0 w-full text-xs border-gray-300 p-2.5  dark:bg-gray-700
dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-sky-500 dark:focus:border-sky-500" placeholder="选填">
                  <!-- 网址 Tooltip -->
              ...
              <div class="w-full mb-4 mt-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                <div class="px-4 py-2 bg-white rounded-t-lg dark:bg-gray-800">
                  ...
                  <textarea id="comment" rows="4" v-model="replyContent"
                    class="w-full px-0 text-sm text-gray-900 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" :placeholder="replyPlaceholderText"
                    required></textarea>
...
const comments = ref([
  {
    id: 39818,
    avatar:
      'https://qh.qlogo.cn/g?b=sdk&ek=AQCCUxlJ6SzcyLnoceicwiaOoqHLfHPDJ48xj7dsbLzfP3LPC0YFw9ibWW1UaIicy2vIIZvUpLDf&s=100&t=1690161385',
    nickname: '野比大雄',
    website: null,
  ...
  },
  {
    id: 39813,
    avatar:
      'https://qh.qlogo.cn/g?b=sdk&ek=AQDW4PNnLEibrRIicSnnZZrBD2siaNCiaiaQec1LEccHQRM7IJun9EAoLh4vU0iasibTHjTKbCFic1VC&s=100&t=1593000563',
    nickname: '璞暮',
    website: null,
    content: '观望\uD83E\uDD11',
    ...
    childComments: [
      {
        id: 39814,
        avatar:
          'https://qh.qlogo.cn/g?b=sdk&ek=AQAJ99lfkKA9TldbMpTOicsyfib30JOuNnqdaFehfOzYz8qEQo3f7JbY24mCKYoZ5meJibLeuDq&s=100&t=1681803828',
        nickname: '犬小哈',
        website: null,
        content: '欢迎欢迎\uD83D\uDE0E',
